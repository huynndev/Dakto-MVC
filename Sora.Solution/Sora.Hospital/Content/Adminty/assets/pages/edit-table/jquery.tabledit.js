        ...
        var defaults = {
            ...
            buttons: {
                ...
                save: {
                    ...
                    html: '<span class="icofont  icofont-check"></span>'
                },
                restore: {
            ...
            columns: {
                ...
                editable: function () {
                    ...
                    for (var i = 0; i < settings.columns.editable.length; i++) {
                        ...
                        $td.each(function () {
                            ...
                            console.log($td.hasClass('textarea'));
                            //var span = '<span class="tabledit-span tabledit-identifier">' + $(this).text() + '</span>';
                            //if ($(this).hasClass('textarea')) {
                            //    var input = '<textarea class="tabledit-input tabledit-identifier" type="hidden" name="' + settings.columns.identifier[1] + '"  disabled> ' + $(this).text() + '</textarea>';
                            //} else {
                            //    var input = '<input class="tabledit-input tabledit-identifier" type="hidden" name="' + settings.columns.identifier[1] + '" value="' + $(this).text() + '" disabled>';
                            //}
                            ...
                            if (typeof settings.columns.editable[i][2] !== 'undefined') {
                                ...
                                if ($(this).hasClass('textarea')) {
                                    var input = '<textarea class="tabledit-input form-control max-textarea ' + settings.inputClass + ' " style="display:none;height:100%; width:100%" type="hidden" rows=15 name="' + settings.columns.editable[i][1] + '"  disabled> ' + text + '</textarea>';
                                } else {
                                    var input = '<input class="tabledit-input form-control " style="display:none"  name="' + settings.columns.editable[i][1] + '" value="' + text + '" style="display: none;" disabled>';
                                }
                            }
                ...
                toolbar: function () {
                    ...
                    if (settings.editButton || settings.deleteButton) {
                        ...
                        $table.find('tr:gt(0)').append('<td style="white-space: nowrap; width: 120px;">' + toolbar + '</td>');
                    }
                }
            }
        };
        ...
        var Edit = {
            reset: function (td) {
                ...
                $(td).each(function () {
                    ...
                    // Get span text.
                    var text = $(this).find('.tabledit-span').html();
